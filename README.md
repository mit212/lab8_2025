...
In this lab, you will be trying out different functions from OpenCV to visualize the computer vision techniques introduced in lecture. The entire lab is designed to take less an hour. Before the lab begins, we will do a quick demo of AprilTag detection and pose estimation along with the necessary associated camera calibration procedure. The rest of lab time is allotted to working on the final project.
